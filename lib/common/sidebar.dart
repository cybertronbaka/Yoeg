                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      MenuItem(
                        ...
                        onTap: () {
                          onIconPressed();
                         // BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.EventRegisterClickedEvent);
                          },
                      ),
                      ...
                      MenuItem(
                        ...
                        onTap: () {
                          onIconPressed();
                      //    BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.NotificationSettingsClickedEvent);
                        },
                      ),
                      MenuItem(
